...
function roots_scripts() {
  wp_enqueue_style('roots_app', get_template_directory_uri() . '/dist/signal.css', false, null);
  ...
  wp_register_script('roots_main', get_template_directory_uri() . '/dist/signal.min.js', false, null, true);

...
module.exports = function(grunt) {	
	grunt.registerTask('patternlab', 'create design systems with atomic design', function(arg) {
		...
		var patternlab = {};
		patternlab.data = grunt.file.readJSON('./patterns/source/_data/data.json');
		patternlab.listitems = grunt.file.readJSON('./patterns/source/_data/listitems.json');
		patternlab.header = grunt.file.read('./patterns/source/_patternlab-files/pattern-header-footer/header.html');
		patternlab.footer = grunt.file.read('./patterns/source/_patternlab-files/pattern-header-footer/footer.html');
		patternlab.patterns = [];
		...
		grunt.file.recurse('./patterns/source/_patterns', function(abspath, rootdir, subdir, filename){
			...
			if(patternIndex === -1){
				...
				if(grunt.util._.str.include(filename, 'json')){
					...
					grunt.file.write('./patterns/public/./patterns/' + flatPatternPath, patternlab.header + currentPattern.patternOutput + patternlab.footer);
		...
		var styleguideTemplate = grunt.file.read('./patterns/source/_patternlab-files/styleguide.mustache');
		var styleguideHtml = mustache.render(styleguideTemplate, {partials: patternlab.patterns});
		grunt.file.write('./patterns/public/styleguide/html/styleguide.html', styleguideHtml);

		//build the patternlab website
		var patternlabSiteTemplate = grunt.file.read('./patterns/source/_patternlab-files/index.mustache');

		//the patternlab site requires a lot of partials to be rendered.
		//patternNav.
		var patternNavTemplate = grunt.file.read('./patterns/source/_patternlab-files/partials/patternNav.mustache');
		...
		//ishControls
		var ishControlsTemplate = grunt.file.read('./patterns/source/_patternlab-files/partials/ishControls.mustache');
		var ishControlsPartialHtml = mustache.render(ishControlsTemplate);

		//patternPaths
		var patternPathsTemplate = grunt.file.read('./patterns/source/_patternlab-files/partials/patternPaths.mustache');
		var patternPathsPartialHtml = mustache.render(patternPathsTemplate, {'patternPaths': JSON.stringify(patternlab.patternPaths)});

		//viewAllPaths
		var viewAllPathsTemplate = grunt.file.read('./patterns/source/_patternlab-files/partials/viewAllPaths.mustache');
		var viewAllPathersPartialHtml = mustache.render(viewAllPathsTemplate, {'viewallpaths': JSON.stringify(patternlab.viewAllPaths)});

		//websockets
		var websocketsTemplate = grunt.file.read('./patterns/source/_patternlab-files/partials/websockets.mustache');
		var config = grunt.file.readJSON('./patterns/config/config.json');
		...
		grunt.file.write('./patterns/public/index.html', patternlabSiteHtml);

		//debug
		var outputFilename = './patterns/patternlab.json';
